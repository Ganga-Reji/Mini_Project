			...
			<div class="row about_content align-items-center">
				<div class="col-lg-6">
					<div class="section_content">
						<h6>About Us</h6>
						<h1>We Believe that <br> Lasts Long</h1>
						<p>We Believe that gaming innovation Lasts Long
			...
			<div class="testi_slider owl-carousel">
				<div class="testi_item">
					...
					<div class="wow fadeIn" data-wow-duration="1s">
						<p>
							We Believe that gaming innovation Lasts LongWe Believe that gaming innovation Lasts Long
							We Believe that gaming innovation Lasts Long
							 <br> and She is the host to your journey.
						</p>
					</div>
				</div>
				<div class="testi_item">
				...
				<div class="testi_item">
					...
					<div class="wow fadeIn" data-wow-duration="1s">
						<p>
							AWe Believe that gaming innovation Lasts Long
							We Believe that gaming innovation Lasts Long
							We Believe that gaming innovation Lasts Long
							 <br> and She is the host to your journey.
						</p>
